...
from ..models import ResourceManagementUnit, Course


class RMUListingTab(ChooserListingTabMixin):
    listing_tab_template = 'modeladmin/campusgo_academic/choosers/_listing_tab.html'
    results_template = 'modeladmin/campusgo_academic/choosers/results_rmu.html'
...
class CourseListingTab(ChooserListingTabMixin):
    listing_tab_template = 'modeladmin/campusgo_academic/choosers/_listing_tab.html'
    results_template = 'modeladmin/campusgo_academic/choosers/results_course.html'
