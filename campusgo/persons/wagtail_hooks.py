...
def register_person_search_area():
    return PersonsSearchArea(
        _('Persons'), reverse('campusgo_persons_person_modeladmin_index'),
...
def register_profile_page_menu(request):
    return {
        'url': reverse('campusgo_persons_person_modeladmin_account_profile_page'),
...
def register_user_personal_account_menu(request):
    return {
        'url': reverse('campusgo_persons_person_modeladmin_account_personal_edit'),
...
def register_contact_account_menu(request):
    return {
        'url': reverse('campusgo_persons_person_modeladmin_account_contact_edit'),
        'label': _('Contacts'),
        'help_text': _('Update your contact and social accounts.')
    }


@hooks.register('campusgo_register_account_menu_item')
def register_user_skills_menu(request):
    return {
        'url': reverse('campusgo_persons_person_modeladmin_account_skill_edit'),
...
def register_education_histories_menu(request):
    return {
        'url': reverse('campusgo_persons_person_modeladmin_account_education_edit'),
        'label': _('Educations'),
...
def register_working_organization_menu(request):
    return {
        'url': reverse('campusgo_persons_person_modeladmin_account_working_edit'),
...
def register_families_menu(request):
    return {
        'url': reverse('campusgo_persons_person_modeladmin_account_family_edit'),
        'label': _('Families'),
