...
from campusgo.importexport.widgets import ExcelDateWidget, UUIDWidget
...
class PersonResource(ModelResource):
    ...
    last_education_level = Field(attribute='last_education_level', column_name='last_education_level',
                                 widget=widgets.CharWidget())
    last_education_institution = Field(attribute='last_education_institution', column_name='last_education_institution',
                                       widget=widgets.CharWidget())
    last_education_name = Field(attribute='last_education_name', column_name='last_education_name',
                                widget=widgets.CharWidget())
