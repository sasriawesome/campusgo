...
from campusgo.admin.helpers import ButtonHelper, AdminURLHelper
from campusgo.printpdf.admin import PrintPDFModelAdminMixin
from campusgo.printpdf.helpers import PrintPDFButtonHelperMixin
from campusgo.importexport.admin import ImportExportModelAdminMixin
from campusgo.importexport.views import ImportExportIndexView
from campusgo.importexport.helpers import ImportExportAdminURLHelperMixin

from campusgo.persons.models import Person
from campusgo.persons.resources import PersonResource
...
class ProfileView(InspectView):
    ...
    template_name = 'modeladmin/campusgo_persons/person/profile.html'
...
class PersonModelAdmin(PrintPDFModelAdminMixin, ModelAdmin):
    model = Person
    ...
    search_fields = [
        ...
        'account__first_name',
        'account__last_name', ]
    list_display = ['fullname_with_title', 'gender']
    list_per_page = 20
