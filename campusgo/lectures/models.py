...
from campusgo.core.utils.datetime import add_time
from wagtail.core.models import Orderable
from modelcluster.models import ClusterableModel, ParentalKey

from campusgo.academic.models import CurriculumCourse, AcademicYear, ResourceManagementUnit
from campusgo.rooms.models import Room
from campusgo.teachers.models import Teacher
from campusgo.students.models import Student, StudentScore
...
class Lecture(ClusterableModel, BaseModel):
    class Meta:
...
class LectureStudent(Orderable, BaseModel):
    class Meta:
