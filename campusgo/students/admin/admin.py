...
from campusgo.students.models import Student, StudentPersonal, StudentScore, ConversionScore

from campusgo.persons.admin import PersonModelAdmin
from campusgo.students.forms import StudentRegistrationForm
...
class StudentPersonalModelAdmin(PersonModelAdmin):
    ...
    list_filter = ['created_at', 'is_matriculant']
    list_display = [
        'inner_id',
        'fullname_with_title',
        'gender',
